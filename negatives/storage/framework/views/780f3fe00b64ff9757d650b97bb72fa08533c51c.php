          ...
          <div class="col-lg-6" >
            <div class="panel panel-success">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-american-sign-language-interpreting"></i> Details</h3>
              </div>
                ...
                <table class="table table-bordered table-hover tablesorter">
                  ...
                  <tbody>
                   <tr ng-repeat="product in donations">
                      ...
                      <td class="col-sm-2"><strong>{{ product.ndonations }}</strong></td>
                    </tr>
                  </tbody>
                </table>
                </div>
