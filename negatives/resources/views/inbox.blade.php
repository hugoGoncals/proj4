...
@section('content')
  <div class="container" ng-controller="InboxController">
    <div class="row">
      <div class="col-md-12">
        ...
        <table class="table table-bordered table-hover tablesorter">
          <thead>
            <tr>
              <th class="col-md-2"><i class="fa fa-commenting-o" aria-hidden="true"></i></th>
              <th>From</th>
              <th>Subject</th>
              <th>Data</th>
              <th>Status</th>
          ...
          <!-- unreaded -->
            <tr ng-repeat="msg in msg"> 
              <td class="col-md-2"><button id="btn-add" class="btn btn-primary btn-sm" ng-click="toggle(msg.id)"> Read </button></td>
              <td>@{{ msg.from }}</td>
              <td>@{{ msg.subject }}</td>
              <td>@{{ msg.datesend }}</td>
          ...
          <!-- readed -->
            <tr ng-repeat="msgr in msgreaded">
              <td class="col-md-2"><button id="btn-add" class="btn btn-primary btn-sm" ng-click="toggle(msgr.id)"> Read </button></td>
              <td>@{{ msgr.from }}</td>
              <td>@{{ msgr.subject }}</td>
              <td>@{{ msgr.datesend }}</td>
