                    ...
                    <ul class="timeline">
                        <li>
                            <div class="timeline-image">
                                <img class="img-circle img-responsive" src="{{ asset('imgs/about/ong1.jpg') }}" alt="">
                            </div>
                        ...
                        <li class="timeline-inverted">
                            <div class="timeline-image">
                                <img class="img-circle img-responsive" src="{{ asset('imgs/about/ong4.jpg') }}" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                        ...
                        <li>
                            <div class="timeline-image">
                                <img class="img-circle img-responsive" src="{{ asset('imgs/about/ong3.jpg') }}" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>2016-NOW</h4>
                        ...
                        <li class="timeline-inverted">
                            <div class="timeline-image">
                                <img class="img-circle img-responsive" src="{{ asset('imgs/about/ong2.jpg') }}" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>NOW</h4>
