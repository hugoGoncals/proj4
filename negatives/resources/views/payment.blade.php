...
<head>
    ...
    <script src="{{asset('/angular/controllers/checkout.js')}}"></script> 


</head>

<body id="page-top" class="index" ng-controller="checkout as vm" style="background-color: #eeeeee  !important">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top affix" style="background-color: #222222">
        ...
        <!-- /.container-fluid -->
            ...
            <center><h1 style="margin-top: 300px;">Page Under Construction</h1></center>
